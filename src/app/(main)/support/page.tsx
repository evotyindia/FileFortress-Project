    ...
    <div className="container mx-auto px-4 py-12 md:py-20">
      <div className="max-w-3xl mx-auto">
        <section className="text-center">
          <h1 className="text-5xl md:text-6xl font-bold font-headline">Support Center</h1>
        ...
        <section className="mt-16 grid sm:grid-cols-1 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <a href="mailto:support@filefortress.app" className="font-semibold text-primary hover:underline text-xl">
                support@filefortress.app
              </a>
              <div className="text-lg text-amber-700 dark:text-amber-400 p-5 bg-amber-500/10 rounded-lg border border-amber-500/20">
